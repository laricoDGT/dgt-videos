...
return!1}return'<iframe src="'+a+'" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'}alert("No video assigned.");return!1}c(".lets-play").click(function(a){a.preventDefault();(a=d(c(this)))&&c("body").append('<div class="active" id="video-wrap"><span class="video-overlay"></span><div class="video-container">'+a+'</div><button class="close-video">x</button></div>').addClass("active")});c(document).on("click",".close-video, .video-overlay",
function(){c("#video-wrap").remove()})})(jQuery);