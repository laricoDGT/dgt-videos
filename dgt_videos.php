...
?>
    ...
    <img src="https://img.youtube.com/vi/<?php echo get_youtube_id_from_url(get_post_meta(get_the_ID(), 'url1', true)); ?>/maxresdefault.jpg" alt="<?php echo get_the_title(); ?>">
   
    
    <button class="lets-play" data-video="<?php echo get_post_meta(get_the_ID(), 'url1', true); ?>" aria-label="Play"><span>Play Video</span></button>
